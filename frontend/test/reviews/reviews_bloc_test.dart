...
import 'package:frontend/reviews/review.dart';

void main() {
  group('Review block', () {
    Review createReview() =>
        Review(rating: 10, comment: "", traineeId: 1, trainerId: 2);
    ...
    group('ReviewsGetAllEvent', () {
      blocTest('emits [success]/[error]',
          ...
          expect: () =>
              [isA<ReviewListLoadError>(), isA<ReviewListLoadSuccess>()]);
    });
    ...
    group('GetTraineeReview', () {
      blocTest('emits [success]/[error]',
          ...
          wait: const Duration(seconds: 5),
          expect: () =>
              [isA<ReviewLoadSuccess>(), isA<ReviewOperationFailure>()]);
    });
    ...
    group('ReviewDeleteReviewEvent', () {
      ...
      blocTest('emitts [opereation success]/[operation failure]',
          ...
          wait: const Duration(seconds: 5),
          expect: () =>
              [isA<ReviewOperationFailure>(), isA<ReviewOperationSuccess>()]);
    });
