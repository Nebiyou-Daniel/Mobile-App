...
import 'package:frontend/application/trainee/bloc/trainee_state.dart' hide TraineeListEmpty;
import 'package:frontend/application/trainer/bloc/trainer_state.dart';
...
void main() {
  group('TrainerState', () {
    ...
    group('TraineeDetailReceivedSuccessfully', () {
      test('check to see initialization', () {
        expect(TraineeLoadSuccess(trainee: trainee).props,
            equals([]));
      });
    });
