...
class NotificationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(title: 'Notification page', home: NotificationHome());
  }
}
...
class NotificationState extends State<NotificationHome> {
  ...
  @override
  Widget build(BuildContext context) {
    ButtonStyle sty = TextButton.styleFrom(
          ...
          child: ListView.separated(
              itemBuilder: (BuildContext context, int i) {
                return NotificationCard(
                    info: notifications[i], date: 'date', time: "time");
              },
...
class NotificationCard extends StatelessWidget {
  ...
  late String? time;
  NotificationCard(
      {super.key, required this.info, this.time, required this.date});
  @override
  Widget build(BuildContext context) {
